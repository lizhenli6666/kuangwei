...
!function (e, t) {
  ...
  function i(e, n, r, i) {
    if (ct.acceptData(e)) {
      ...
      if (c && l[c] && (i || l[c].data) || r !== t || "string" != typeof n) return c || (c = u ? e[s] = tt.pop() || ct.guid++ : s), l[c] || (l[c] = u ? {} : {
        toJSON: ct.noop
      }), ("object" == _typeof(n) || "function" == typeof n) && (i ? l[c] = ct.extend(l[c], n) : l[c].data = ct.extend(l[c].data, n)), a = l[c], i || (a.data || (a.data = {}), a = a.data), r !== t && (a[ct.camelCase(n)] = r), "string" == typeof n ? (o = a[n], null == o && (o = a[ct.camelCase(n)])) : o = a, o;
    }
  }
  ...
  function x(e, n) {
    var r,
        i,
        o = 0,
        a = _typeof(e.getElementsByTagName) !== Y ? e.getElementsByTagName(n || "*") : _typeof(e.querySelectorAll) !== Y ? e.querySelectorAll(n || "*") : t;
  ...
  function N(e, t) {
    for (var n, r, i, o = [], a = 0, s = e.length; s > a; a++) {
      r = e[a], r.style && (o[a] = ct._data(r, "olddisplay"), n = r.style.display, t ? (o[a] || "none" !== n || (r.style.display = ""), "" === r.style.display && C(r) && (o[a] = ct._data(r, "olddisplay", A(r.nodeName)))) : o[a] || (i = C(r), (n && "none" !== n || !i) && ct._data(r, "olddisplay", i ? n : ct.css(r, "display"))));
    }
  ...
  function E(e, t, n, r, i) {
    for (var o = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0, a = 0; 4 > o; o += 2) {
      "margin" === n && (a += ct.css(e, n + Nn[o], !0, i)), r ? ("content" === n && (a -= ct.css(e, "padding" + Nn[o], !0, i)), "margin" !== n && (a -= ct.css(e, "border" + Nn[o] + "Width", !0, i))) : (a += ct.css(e, "padding" + Nn[o], !0, i), "padding" !== n && (a += ct.css(e, "border" + Nn[o] + "Width", !0, i)));
    }
  ...
  function D(e, t, n, r) {
    ...
    if (ct.isArray(t)) ct.each(t, function (t, i) {
      n || Sn.test(e) ? r(e, i) : D(e + "[" + ("object" == _typeof(i) ? t : "") + "]", i, n, r);
    });else if (n || "object" !== ct.type(t)) r(e, t);else for (i in t) {
      D(e + "[" + i + "]", t[i], n, r);
    }
  }
  ...
  ct.fn = ct.prototype = {
    ...
    init: function init(e, n, r) {
      ...
      if ("string" == typeof e) {
        ...
        if (i[1]) {
          if (n = n instanceof ct ? n[0] : n, ct.merge(this, ct.parseHTML(i[1], n && n.nodeType ? n.ownerDocument || n : G, !0)), gt.test(i[1]) && ct.isPlainObject(n)) for (i in n) {
    ...
    for ("boolean" == typeof s && (c = s, s = arguments[1] || {}, u = 2), "object" == _typeof(s) || ct.isFunction(s) || (s = {}), l === u && (s = this, --u); l > u; u++) {
      if (null != (o = arguments[u])) for (i in o) {
        e = s[i], r = o[i], s !== r && (c && r && (ct.isPlainObject(r) || (n = ct.isArray(r))) ? (n ? (n = !1, a = e && ct.isArray(e) ? e : []) : a = e && ct.isPlainObject(e) ? e : {}, s[i] = ct.extend(c, a, r)) : r !== t && (s[i] = r));
      }
    }
    ...
    type: function type(e) {
      return null == e ? e + "" : "object" == _typeof(e) || "function" == typeof e ? et[st.call(e)] || "object" : _typeof(e);
    },
    isPlainObject: function isPlainObject(e) {
      ...
      if (ct.support.ownLast) for (n in e) {
        return ut.call(e, n);
      }
    ...
    proxy: function proxy(e, n) {
      var r, i, o;
      return "string" == typeof n && (o = e[n], n = e, e = o), ct.isFunction(e) ? (r = ot.call(arguments, 2), i = function i() {
    ...
    access: function access(e, n, r, i, o, a, s) {
      ...
      } else if (i !== t && (o = !0, ct.isFunction(i) || (s = !0), c && (s ? (n.call(e, i), n = null) : (c = n, n = function n(e, t, _n2) {
        return c.call(ct(e), _n2);
      })), n)) for (; l > u; u++) {
      ...
      if (_ && !r) {
        ...
        if (C.qsa && (!M || !M.test(e))) {
          if (f = c = P, h = t, g = 9 === s && e, 1 === s && "object" !== t.nodeName.toLowerCase()) {
            for (l = p(e), (c = t.getAttribute("id")) ? f = c.replace(wt, "\\$&") : t.setAttribute("id", f), f = "[id='" + f + "'] ", u = l.length; u--;) {
              l[u] = f + d(l[u]);
            }
    ...
    function p(e, t) {
      ...
      for (s = e, u = [], l = k.preFilter; s;) {
        ...
        for (a in k.filter) {
          !(i = yt[a].exec(s)) || l[a] && !(i = l[a](i)) || (r = i.shift(), o.push({
            value: r,
            type: a,
            matches: i
          }), s = s.slice(r.length));
    ...
    function y(e, t, n, r, o, a) {
      return r && !r[P] && (r = y(r)), o && !o[P] && (o = y(o, a)), i(function (i, a, s, u) {
        var l,
            ...
            v = n ? o || (i ? e : h || r) ? [] : a : y;
        if (n && n(y, v, s, u), r) for (l = m(v, d), r(l, [], s, u), c = l.length; c--;) {
          (f = l[c]) && (v[d[c]] = !(y[d[c]] = f));
        }
    ...
    function b(e, t) {
      var r = 0,
        ...
        var f,
            ...
            b = null != c,
            x = j,
            T = i || a && k.find.TAG("*", c && _s.parentNode || _s),
            w = W += null == x ? 1 : Math.random() || .1;

        for (b && (j = _s !== H && _s, N = r); null != (f = T[y]); y++) {
          if (a && f) {
            for (p = 0; d = e[p++];) {
              if (d(f, _s, u)) {
                l.push(f);
    ...
    S = n.isXML = function (e) {
      ...
      return n !== H && 9 === n.nodeType && n.documentElement ? (H = n, q = n.documentElement, _ = !S(n), r && r.attachEvent && r !== r.top && r.attachEvent("onbeforeunload", function () {
        ...
        var t = e.replace(Ct, Nt);
        return function (e) {
          var n = _typeof(e.getAttributeNode) !== Y && e.getAttributeNode("id");
          return n && n.value === t;
        };
      }), k.find.TAG = C.getElementsByTagName ? function (e, n) {
        return _typeof(n.getElementsByTagName) !== Y ? n.getElementsByTagName(e) : t;
      } : function (e, t) {
        var n,
            r = [],
            i = 0,
        ...
        return _typeof(n.getElementsByClassName) !== Y && _ ? n.getElementsByClassName(e) : t;
  ...
  ct.Callbacks = function (e) {
    ...
    return t.ownLast = "0" !== c, ct(function () {
      ...
      a && (n = G.createElement("div"), n.style.cssText = "border:0;width:0;height:0;position:absolute;top:0;left:-9999px;margin-top:1px", a.appendChild(n).appendChild(f), f.innerHTML = "<table><tr><td></td><td>t</td></tr></table>", i = f.getElementsByTagName("td"), i[0].style.cssText = "padding:0;margin:0;border:0;display:none", l = 0 === i[0].offsetHeight, i[0].style.display = "", i[1].style.display = "none", t.reliableHiddenOffsets = l && 0 === i[0].offsetHeight, f.innerHTML = "", f.style.cssText = "box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;padding:1px;border:1px;display:block;width:4px;margin-top:1%;position:absolute;top:1%;", ct.swap(a, null != a.style.zoom ? {
        ...
        width: "4px"
      }).width, r = f.appendChild(G.createElement("div")), r.style.cssText = f.style.cssText = o, r.style.marginRight = r.style.width = "0", f.style.width = "1px", t.reliableMarginRight = !parseFloat((e.getComputedStyle(r, null) || {}).marginRight)), _typeof(f.style.zoom) !== Y && (f.innerHTML = "", f.style.cssText = o + "width:1px;padding:1px;display:inline;zoom:1", t.inlineBlockNeedsLayout = 3 === f.offsetWidth, f.style.display = "block", f.innerHTML = "<div></div>", f.firstChild.style.width = "5px", t.shrinkWrapBlocks = 3 !== f.offsetWidth, t.inlineBlockNeedsLayout && (a.style.zoom = 1)), a.removeChild(n), n = f = i = r = null);
    }), n = o = a = s = r = i = null, t;
  }({});
  var Et = /(?:\{[\s\S]*\}|\[[\s\S]*\])$/,
      St = /([A-Z])/g;
  ct.extend({
      ...
      if (e === t) {
        if (this.length && (o = ct.data(u), 1 === u.nodeType && !ct._data(u, "parsedAttrs"))) {
          for (r = u.attributes; r.length > s; s++) {
            i = r[s].name, 0 === i.indexOf("data-") && (i = ct.camelCase(i.slice(5)), a(u, i, o[i]));
          }
    ...
    promise: function promise(e, n) {
      ...
      for ("string" != typeof e && (n = e, e = t), e = e || "fx"; s--;) {
        r = ct._data(a[s], e + "queueHooks"), r && r.empty && (i++, r.empty.add(u));
      }
  ...
  ct.fn.extend({
    ...
    toggleClass: function toggleClass(e, t) {
      ...
      return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : this.each(ct.isFunction(e) ? function (n) {
        ...
        if ("string" === n) for (var t, r = 0, i = ct(this), o = e.match(pt) || []; t = o[r++];) {
    ...
    attr: function attr(e, n, r) {
      var i,
          o,
          a = e.nodeType;
      return e && 3 !== a && 8 !== a && 2 !== a ? _typeof(e.getAttribute) === Y ? ct.prop(e, n, r) : (1 === a && ct.isXMLDoc(e) || (n = n.toLowerCase(), i = ct.attrHooks[n] || (ct.expr.match.bool.test(n) ? jt : At)), r === t ? i && "get" in i && null !== (o = i.get(e, n)) ? o : (o = ct.find.attr(e, n), null == o ? t : o) : null !== r ? i && "set" in i && (o = i.set(e, r, n)) !== t ? o : (e.setAttribute(n, r + ""), r) : (ct.removeAttr(e, n), t)) : void 0;
    },
    removeAttr: function removeAttr(e, t) {
      ...
      if (o && 1 === e.nodeType) for (; n = o[i++];) {
        r = ct.propFix[n] || n, ct.expr.match.bool.test(n) ? Ot && Mt || !_t.test(n) ? e[r] = !1 : e[ct.camelCase("default-" + n)] = e[r] = !1 : ct.attr(e, n, ""), e.removeAttribute(Mt ? n : r);
      }
    },
    attrHooks: {
      type: {
  ...
  ct.event = {
    ...
    add: function add(e, n, r, i, o) {
      ...
      if (y) {
        for (r.handler && (l = r, r = l.handler, o = l.selector), r.guid || (r.guid = ct.guid++), (s = y.events) || (s = y.events = {}), (f = y.handle) || (f = y.handle = function (e) {
          return _typeof(ct) === Y || e && ct.event.triggered === e.type ? t : ct.event.dispatch.apply(f.elem, arguments);
        }, f.elem = e), n = (n || "").match(pt) || [""], u = n.length; u--;) {
          a = Wt.exec(n[u]) || [], h = m = a[1], g = (a[2] || "").split(".").sort(), h && (c = ct.event.special[h] || {}, h = (o ? c.delegateType : c.bindType) || h, c = ct.event.special[h] || {}, p = ct.extend({
            type: h,
            origType: m,
            data: i,
            handler: r,
      ...
      if (m && (c = m.events)) {
        for (t = (t || "").match(pt) || [""], l = t.length; l--;) {
          if (s = Wt.exec(t[l]) || [], d = g = s[1], h = (s[2] || "").split(".").sort(), d) {
            for (f = ct.event.special[d] || {}, d = (r ? f.delegateType : f.bindType) || d, p = c[d] || [], s = s[2] && RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), u = o = p.length; o--;) {
    ...
    trigger: function trigger(n, r, i, o) {
      ...
      if (u = f = i = i || G, 3 !== i.nodeType && 8 !== i.nodeType && !Rt.test(h + ct.event.triggered) && (h.indexOf(".") >= 0 && (g = h.split("."), h = g.shift(), g.sort()), s = 0 > h.indexOf(":") && "on" + h, n = n[ct.expando] ? n : new ct.Event(h, "object" == _typeof(n) && n), n.isTrigger = o ? 2 : 3, n.namespace = g.join("."), n.namespace_re = n.namespace ? RegExp("(^|\\.)" + g.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, n.result = t, n.target || (n.target = i), r = null == r ? [n] : ct.makeArray(r, [n]), c = ct.event.special[h] || {}, o || !c.trigger || c.trigger.apply(i, r) !== !1)) {
        ...
        for (p = 0; (u = d[p++]) && !n.isPropagationStopped();) {
          n.type = p > 1 ? l : c.bindType || h, a = (ct._data(u, "events") || {})[n.type] && ct._data(u, "handle"), a && a.apply(u, r), a = s && u[s], a && ct.acceptData(u) && a.apply && a.apply(u, r) === !1 && n.preventDefault();
        }
      ...
      if (u[0] = e, e.delegateTarget = this, !c.preDispatch || c.preDispatch.call(this, e) !== !1) {
        for (s = ct.event.handlers.call(this, e, l), n = 0; (o = s[n++]) && !e.isPropagationStopped();) {
          for (e.currentTarget = o.elem, a = 0; (i = o.handlers[a++]) && !e.isImmediatePropagationStopped();) {
            (!e.namespace_re || e.namespace_re.test(i.namespace)) && (e.handleObj = i, e.data = i.data, r = ((ct.event.special[i.origType] || {}).handle || i.handler).apply(o.elem, u), r !== t && (e.result = r) === !1 && (e.preventDefault(), e.stopPropagation()));
          }
        }
    ...
    handlers: function handlers(e, n) {
      ...
      if (u && l.nodeType && (!e.button || "click" !== e.type)) for (; l != this; l = l.parentNode || this) {
        if (1 === l.nodeType && (l.disabled !== !0 || "click" !== e.type)) {
          for (o = [], a = 0; u > a; a++) {
            i = n[a], r = i.selector + " ", o[r] === t && (o[r] = i.needsContext ? ct(r, this).index(l) >= 0 : ct.find(r, this, null, [l]).length), o[r] && o.push(i);
          }
    ...
    fix: function fix(e) {
      ...
      for (a || (this.fixHooks[i] = a = Pt.test(i) ? this.mouseHooks : Bt.test(i) ? this.keyHooks : {}), r = a.props ? this.props.concat(a.props) : this.props, e = new ct.Event(o), t = r.length; t--;) {
        n = r[t], e[n] = o[n];
      }
    ...
    var r = "on" + t;
    e.detachEvent && (_typeof(e[r]) === Y && (e[r] = null), e.detachEvent(r, n));
  ...
  sn.optgroup = sn.option, sn.tbody = sn.tfoot = sn.colgroup = sn.caption = sn.thead, sn.th = sn.td, ct.fn.extend({
    ...
    html: function html(e) {
      return ct.access(this, function (e) {
        ...
        if (!("string" != typeof e || en.test(e) || !ct.support.htmlSerialize && Yt.test(e) || !ct.support.leadingWhitespace && Jt.test(e) || sn[(Qt.exec(e) || ["", ""])[1].toLowerCase()])) {
          ...
          try {
            for (; i > r; r++) {
              n = this[r] || {}, 1 === n.nodeType && (ct.cleanData(x(n, !1)), n.innerHTML = e);
            }
    ...
    domManip: function domManip(e, t, n) {
      ...
      if (c && (u = ct.buildFragment(e, this[0].ownerDocument, !1, !n && this), r = u.firstChild, 1 === u.childNodes.length && (u = r), r)) {
        for (a = ct.map(x(u, "script"), g), o = a.length; c > l; l++) {
          i = u, l !== p && (i = ct.clone(i, !0, !0), o && ct.merge(a, x(i, "script"))), t.call(this[l], i, l);
        }

        if (o) for (s = a[a.length - 1].ownerDocument, ct.map(a, m), l = 0; o > l; l++) {
          i = a[l], rn.test(i.type || "") && !ct._data(i, "globalEval") && ct.contains(s, i) && (i.src ? ct._evalUrl(i.src) : ct.globalEval((i.text || i.textContent || i.innerHTML || "").replace(an, "")));
        }
        u = r = null;
      }
    ...
    clone: function clone(e, t, n) {
      ...
      if (ct.support.html5Clone || ct.isXMLDoc(e) || !Yt.test("<" + e.nodeName + ">") ? o = e.cloneNode(!0) : (ln.innerHTML = e.outerHTML, ln.removeChild(o = ln.firstChild)), !(ct.support.noCloneEvent && ct.support.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || ct.isXMLDoc(e))) for (r = x(o), s = x(e), a = 0; null != (i = s[a]); ++a) {
        r[a] && b(i, r[a]);
      }
    ...
    buildFragment: function buildFragment(e, t, n, r) {
      for (var i, o, a, s, u, l, c, f = e.length, p = d(t), h = [], g = 0; f > g; g++) {
        if (o = e[g], o || 0 === o) if ("object" === ct.type(o)) ct.merge(h, o.nodeType ? [o] : o);else if (Zt.test(o)) {
          for (s = s || p.appendChild(t.createElement("div")), u = (Qt.exec(o) || ["", ""])[1].toLowerCase(), c = sn[u] || sn._default, s.innerHTML = c[1] + o.replace(Gt, "<$1></$2>") + c[2], i = c[0]; i--;) {
            s = s.lastChild;
          }

          if (!ct.support.leadingWhitespace && Jt.test(o) && h.push(t.createTextNode(Jt.exec(o)[0])), !ct.support.tbody) for (o = "table" !== u || Kt.test(o) ? "<table>" !== c[1] || Kt.test(o) ? 0 : s : s.firstChild, i = o && o.childNodes.length; i--;) {
      ...
      for (s && p.removeChild(s), ct.support.appendChecked || ct.grep(x(h, "input"), T), g = 0; o = h[g++];) {
        if ((!r || -1 === ct.inArray(o, r)) && (a = ct.contains(o.ownerDocument, o), s = x(p.appendChild(o), "script"), a && y(s), n)) for (i = 0; o = s[i++];) {
    ...
    cleanData: function cleanData(e, t) {
      for (var n, r, i, o, a = 0, s = ct.expando, u = ct.cache, l = ct.support.deleteExpando, c = ct.event.special; null != (n = e[a]); a++) {
        if ((t || ct.acceptData(n)) && (i = n[s], o = i && u[i])) {
          ...
          u[i] && (delete u[i], l ? delete n[s] : _typeof(n.removeAttribute) !== Y ? n.removeAttribute(s) : n[s] = null, tt.push(i));
        }
      }
    },
  ...
  ct.fn.extend({
    ...
    style: function style(e, n, r, i) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        ...
        if (a = _typeof(r), "string" === a && (o = xn.exec(r)) && (r = (o[1] + 1) * o[2] + parseFloat(ct.css(e, n)), a = "number"), !(null == r || "number" === a && isNaN(r) || ("number" !== a || ct.cssNumber[u] || (r += "px"), ct.support.clearCloneStyle || "" !== r || 0 !== n.indexOf("background") || (l[n] = "inherit"), s && "set" in s && (r = s.set(e, r, i)) === t))) try {
          l[n] = r;
        } catch (c) {}
      }
    },
  ...
  }) : G.documentElement.currentStyle && (fn = function fn(e) {
  ...
  Ln = Wn.exec(Hn.toLowerCase()) || [], ct.fn.load = function (e, n, r) {
    ...
    var i,
        ...
        s = this,
        u = e.indexOf(" ");
    return u >= 0 && (i = e.slice(u, e.length), e = e.slice(0, u)), ct.isFunction(n) ? (r = n, n = t) : n && "object" == _typeof(n) && (a = "POST"), s.length > 0 && ct.ajax({
      url: e,
      type: a,
      dataType: "html",
      data: n
      ...
      return {
        send: function send(i, o) {
          ...
          u.send(n.hasContent && n.data || null), _r = function r(e, i) {
            ...
            try {
              if (_r && (i || 4 === u.readyState)) if (_r = t, a && (u.onreadystatechange = ct.noop, Kn && delete Jn[a]), i) 4 !== u.readyState && u.abort();else {
            ...
            f && o(s, c, f, l);
          }, n.async ? 4 === u.readyState ? setTimeout(_r) : (a = ++Qn, Kn && (Jn || (Jn = {}, ct(e).unload(Kn)), Jn[a] = _r), u.onreadystatechange = _r) : _r();
        },
        abort: function abort() {
          _r && _r(t, !0);
        }
  ...
  ct.Animation = ct.extend(R, {
    ...
    finish: function finish(e) {
      return e !== !1 && (e = e || "fx"), this.each(function () {
        ...
        for (n.finish = !0, ct.queue(this, e, []), i && i.stop && i.stop.call(this, !0), t = o.length; t--;) {
    ...
    var r = e && "object" == _typeof(e) ? ct.extend({}, e) : {
    ...
    var n,
      ...
      left: 0
        ...
        o = this[0],
        a = o && o.ownerDocument;
    return a ? (n = a.documentElement, ct.contains(n, o) ? (_typeof(o.getBoundingClientRect) !== Y && (i = o.getBoundingClientRect()), r = X(a), {
    ...
    return this.length;
  }, ct.fn.andSelf = ct.fn.addBack, "object" == (typeof module === "undefined" ? "undefined" : _typeof(module)) && module && "object" == _typeof(module.exports) ? module.exports = ct : (e.jQuery = e.$ = ct, "function" == typeof define && define.amd && define("jquery", [], function () {
    return ct;
  }));
}(window);